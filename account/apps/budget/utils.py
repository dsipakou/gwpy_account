...
def get_first_day_of_current_month(current_date: Optional[str] = None) -> datetime:
    if current_date:
...
def get_first_day_of_prev_month(current_date: Optional[str] = None) -> datetime:
    return get_first_day_of_current_month(current_date) - relativedelta(months=1)


def get_last_day_of_prev_month(current_date: Optional[str] = None) -> datetime:
    return get_first_day_of_current_month(current_date) - relativedelta(days=1)


def get_first_day_of_current_week(current_date: Optional[str] = None) -> datetime:
    if current_date:
...
def get_last_day_of_current_week(current_date: Optional[str] = None) -> datetime:
    return get_first_day_of_current_week(current_date) + datetime.timedelta(days=6)


def get_first_day_of_prev_week(current_date: Optional[str] = None) -> datetime:
    return get_first_day_of_current_week(current_date) - datetime.timedelta(days=7)


def get_last_day_of_prev_week(current_date: Optional[str] = None) -> datetime:
